#instructions: Something about these if statements aren't giving the desired effect.
# Look at them and see how to fix them. (Run them yourself and see what the output is!)
